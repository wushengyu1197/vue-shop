  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="是否发货" prop="id_send">
          <template slot-scope="scope">
            {{scope.row.is_send}}
          </template>
        </el-table-column>
    ...
    <el-dialog title="修改地址" :visible.sync="addressVisible"
      ...
      <el-form :model="addressForm" :rules="addressFormRules"
        ...
        <el-form-item label="省市区/县" prop="address1">
          <el-cascader :options="city_data2017_element" v-model="addressForm.address1"></el-cascader>
        </el-form-item>
...
<script>
import city_data2017_element from "./city_data2017_element.js";
export default {
  data(){
    return{
      queryInfo:{
